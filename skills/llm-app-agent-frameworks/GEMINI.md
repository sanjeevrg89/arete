# GEMINI.md — Llm App Agent Frameworks
...
> (2026) — verify version-sensitive API fields, flags, and SKUs against current upstream docs.

@./llm-app-agent-frameworks-guide.md
