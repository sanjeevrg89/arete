# GEMINI.md — Experimentation Causal Inference
...
> (2026) — verify version-sensitive APIs, flags, benchmarks, and citations against current sources.

@./experimentation-causal-inference-guide.md
